...
"""
    AlternativeForwardPass(
        forward_model::RVSDDP.PolicyGraph{T};
...
[`RVSDDP.AlternativePostIterationCallback`](@ref) to the `post_iteration_callback`
argument of [`RVSDDP.train`](@ref).
...
[`RVSDDP.AlternativeForwardPass`](@ref) is used.
"""
