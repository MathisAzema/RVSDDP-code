...
"""
	RVSDDP.SpaghettiPlot(; stages, scenarios)
...
"""
	RVSDDP.add_spaghetti(data_function::Function, plt::SpaghettiPlot; kwargs...)
...
plt = RVSDDP.spaghetti_plot(simulations)
RVSDDP.add_spaghetti(plt; title = "Stage objective") do data
...
function save(p::SpaghettiPlot, args...; kwargs...)
    Base.depwarn("`RVSDDP.save` is deprecated. Use `RVSDDP.plot` instead.", :save)
