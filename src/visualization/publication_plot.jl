...
# Internal function: convert dataset (from RVSDDP.simulate) into a matrix where
...
## Examples
    ...
    RVSDDP.publication_plot(simulations; title = "My title") do data
...
function publication_plot(
    ...
    return RVSDDP.publicationplot(simulations, data_function; kwargs...)
end
