...
open("my_model.sof.json", "w") do io
    write(
        ...
        author = "@odow",
        date = "2020-07-20",
        description = "Example problem for the RVSDDP.jl documentation",
    )
end
```
"""
...
function _reformulate_objective(
    ...
    if changing_objective_constant
        new_name = "_RVSDDPjl_random_objective_constant_"
    ...
    if length(changing_objective_coefficient) > 0
        ...
        for x in changing_objective_coefficient
            new_name = "_RVSDDPjl_random_objective_$(name(x))_"
            y = _add_new_random_variable(
                node,
                new_name,
                random_variables,
...
function _reformulate_lower_bound(
    ...
    new_name = "_RVSDDPjl_lower_bound_$(name(x))_"
    y = _add_new_random_variable(
        node,
        new_name,
        random_variables,
...
function _reformulate_upper_bound(
    ...
    new_name = "_RVSDDPjl_upper_bound_$(name(x))_"
    y = _add_new_random_variable(
        node,
        new_name,
        random_variables,
...
function _reformulate_constraint_rhs(
    ...
    new_name = "_RVSDDPjl_rhs_$(name(ci))_"
    y = _add_new_random_variable(
        node,
        new_name,
        random_variables,
